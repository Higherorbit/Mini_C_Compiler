...
FUNCTION_CALLSTMTS: FUNC LPAREN RPAREN SEMICOLON 
    | ID ASSIGNMENT FUNC LPAREN RPAREN SEMICOLON
    | TYPE ID ASSIGNMENT FUNC LPAREN ULTIMATE_LIST RPAREN SEMICOLON
    | ID ASSIGNMENT FUNC LPAREN ULTIMATE_LIST RPAREN SEMICOLON
    | FUNC LPAREN ULTIMATE_LIST RPAREN SEMICOLON
    | TYPE ID ASSIGNMENT FUNC LPAREN RPAREN SEMICOLON 
    ;
...
EXPRESSION: TREEM Comperator TREEM {printf("\nhi\n");}| TREEM 
;

TREEM : TREEM PLUS TREEM2 {printf("\nhi22\n");}
    | TREEM MINUS TREEM2
    | TREEM MULT TREEM2
    | TREEM DIV TREEM2
    | TREEM2
